...
- **Ручки MVM ESSE Z-1210 SN/CP:** описи базової ручки, комплекту з накладкою під циліндр і комплекту з накладкою під WC, по 6 характеристик, 3 FAQ та meta українською і російською. Файл `2026_09_23_mvm_z1210_batch_01.json`; матеріал, серію, форму розетки й покриття звірено з офіційною карткою MVM, комплектацію — з картками Bona Doors.
