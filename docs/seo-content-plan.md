...
- **Комплектуючі Status RAL 9003:** описи 5 карток телескопічного коробу, лиштви та доборів, по 6 характеристик, 3 FAQ та meta українською і російською. Файл `2026_09_25_status_components_batch_01.json`; для доборів окремо показано розмір чинної картки 2200 мм і технічний розмір Status 2070 мм із вимогою підтвердити фактичну довжину до оплати. Одночасно виправлено переплутані UA/RU описи добору 90 мм. Наповнено 29 із 94 комплектуючих у плані.
