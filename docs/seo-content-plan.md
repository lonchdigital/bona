...
- **Ручки MVM ESSE Z-1210, STYLE Z-1220 та FRIO SLIM Z-1220/E20:** описи базових ручок і комплектів із накладкою під циліндр або WC у чорному, матовому нікелі та SN/CP, по 6 характеристик, 3 FAQ та meta українською і російською. Файли `2026_09_23_mvm_z1210_batch_01.json` і `2026_09_23_mvm_z1220_batch_01.json`; матеріал, серію, форму розетки й покриття звірено з офіційними картками MVM, комплектацію — з картками Bona Doors.
