...
5. [Що потребує доробки коду перед наповненням](#5-що-потребує-доробки-коду-перед-наповненням)
6. [Правила написання](#6-правила-написання)
7. [Що вже зроблено](#7-що-вже-зроблено)

---

## 1. Як завантажувати контент товарів

Для **товарів** імпорт уже готовий. Для категорій, посадкових сторінок і послуг його поки немає (див. [розділ 5](#5-що-потребує-доробки-коду-перед-наповненням)).
...
>
> ⚠️ **Мета-теги не перезаписуються.** Якщо в товару вже вписано `meta_title` (наприклад, однаковий для 23 плінтусів), імпорт його не змінить. Для таких груп потрібен прапорець `replace_meta` — див. [розділ 5](#5-що-потребує-доробки-коду-перед-наповненням).
...
| 2 | Ручки **МВМ** | 268 товарів | Немає ні опису, ні характеристик; RU-версії «Виявлено – не проіндексовано» | Описи + характеристики |
...
### 3.2. Ручки МВМ — 268 товарів (пріоритет 2)
...
**Моделі:** A-1209 (3), A-1220 (3), A-1355 (3), A-2003 (3), A-2004 (12), A-2005 (6), A-2006 (6), A-2008 (6), A-2010/E20 (9), A-2015/E20 (12), A-2017 (3), A-2018 (12), A-2020 (9), A-2021 (9), A-2022 (2), A-2024 (6), A-2025 (6), A-2028 (6), A-2029 (6), A-2030 (6), Z-1210 (3), Z-1220 (3), Z-1220/E20 (6), Z-1259 (6), Z-1290 (3), Z-1311 (3), Z-1312 (6), Z-1319 (2), Z-1320/E20 (12), Z-1325 (6), Z-1355 (3), Z-1420 (6), Z-1807 (6), Z-1808 (6), Z-1809 (6), Z-1809/E20 (9), Z-1810 (15), Z-1811 (6), Z-1811/E20 (9), Z-1812 (6), Z-1813 (9), Z-1814 (9).
...
<details>
<summary>Список slug (268)</summary>
...
**Потрібно:** унікальні `meta_title` (до 65 символів, з назвою моделі й розміром або кольором) і `meta_description` (130–165 символів). Потребує `replace_meta` — див. [розділ 5](#5-що-потребує-доробки-коду-перед-наповненням).
...
**Текст для кожної сторінки** (після доробки з [розділу 5](#5-що-потребує-доробки-коду-перед-наповненням)): 300–500 слів — ознаки стилю, до яких інтер'єрів пасує, кольори й фурнітура, 4–5 FAQ. UA + RU.
...
**Потрібно:** вступний текст 150–300 слів на кожну (UA + RU): з чим поєднується колір, у яких інтер'єрах доречний, з якою фурнітурою. Поле для тексту з'явиться після доробки з [розділу 5](#5-що-потребує-доробки-коду-перед-наповненням).
...
## 5. Що потребує доробки коду перед наповненням
...
| **Прапорець `replace_meta` в імпорті** | Однакові meta_title плінтусів і технічних дверей імпорт зараз не перезапише | Невелика зміна в `ProductContentImporter` |
| **Імпорт для категорій і груп фільтрів** (необов'язково) | Щоб наповнювати тексти категорій і посадкових сторінок через той самий API, а не вручну | Новий імпортер за зразком товарного |
