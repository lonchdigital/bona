...
Стан на 26.09.2026: підготовлено окремі природні російські версії для перших 2 із 20 статей — гіда з вибору міжкімнатних дверей та огляду бренду Danapris. Перекладені назви, власні RU-slug, анонси, повні тексти, meta title, meta description і по 5 FAQ; усе зберігається у звичайних полях статті та редагується в адмінці блогу. Файл `database/content/blog/2026_09_26_blog_ru_batch_01.json`.
