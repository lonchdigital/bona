...
Для **товарів** імпорт уже готовий. Для категорій, посадкових сторінок і послуг його поки немає (див. [розділ 6](#6-що-потребує-доробки-коду-перед-наповненням)).
...
- **Пілотна група Korfad ALIANO:** унікальні описи, характеристики, FAQ та meta для AL-01 і AL-02 українською та російською. Файл `2026_09_22_korfad_aliano_batch_01.json`; факти звірені з офіційним каталогом KORFAD.
