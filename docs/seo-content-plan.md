...
Стан на 26.09.2026: підготовлено окремі природні російські версії для перших 4 із 20 статей — гіда з вибору міжкімнатних дверей, огляду бренду Danapris, матеріалу про Comeo Porte та гіда з вибору білого RAL 9003. Перекладені назви, власні RU-slug, анонси, повні тексти, meta title, meta description і по 5 FAQ; усе зберігається у звичайних полях статті та редагується в адмінці блогу. Файли `database/content/blog/2026_09_26_blog_ru_batch_01.json` і `database/content/blog/2026_09_26_blog_ru_batch_02.json`.
