    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/img/storefront/mega-menu/modern-artporte-ostin.webp',
                'resources/img/storefront/mega-menu/classic-omega-milan.webp',
                'resources/img/storefront/mega-menu/neoclassic-bonadoors-dublin.webp',
                'resources/img/storefront/mega-menu/minimal-artporte-new-york.webp',
                'resources/img/storefront/mega-menu/hitech-bonadoors-glasso.webp',
                'bona-html/img/interior-hidden-bedroom.webp',
                'bona-html/img/interior-bedroom.jpg',
                'bona-html/img/interior-living.jpg',
                'bona-html/img/interior-sliding-office.webp',
