    ...
    $.extend(Fastsearch.prototype, {
        ...
        init: function(inputElement, options) {
            ...
            Fastsearch.pickTo(options, this.$el.data(), [
                'url', 'onItemSelect', 'onLoad', 'noResultsText', 'inputIdName', 'apiInputName'
            ]);
...
(function(root, factory) {
    ...
    $.extend(Fastselect.prototype, {
        ...
        init: function(inputElement, options) {
            ...
            this.optionsCollection = new OptionsCollection(pickTo({multipleValues: this.isMultiple}, this.options, [
                'url', 'loadOnce', 'parseData', 'onLoad', 'matcher'
            ]));
        ...
        setupEvents: function() {
            ...
            if (this.isMultiple) {
                ...
                this.$el.on('change', function (e) {
                    var originalInput = this.querySelectorAll('input')[1];

                    if (originalInput && originalInput.value == '') {
                        self.$el.find('.fstToggleBtn').html('');
                    }
    ...
    $.extend(OptionsCollection.prototype, {
        ...
        load: function(params, onDone) {
            ...
            let url = this.options.onLoad ? this.options.onLoad() : options.url;
