...
<head>
    ...
    <!-- Icons CSS -->
    <link rel="stylesheet" href="/static-admin/css/custom.css?v={{ filemtime(public_path('static-admin/css/custom.css')) }}">
...
{{--
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
                ...
                <li class="nav-item w-100">
                    <a class="nav-link pl-3" href="{{ route('admin.promo-code.list.page') }}">
...
<ul class="navbar-nav flex-fill w-100 mb-2">
    ...
    <li class="nav-item w-100">
        <a class="nav-link pl-3" href="{{ route('admin.customer-review.list.page') }}">
            <i class="fe fe-message-square fe-16"></i>
            <span class="ml-1 item-text">{{ trans('admin.customer_reviews') }}</span>
        </a>
    </li>
    <li class="nav-item w-100">
