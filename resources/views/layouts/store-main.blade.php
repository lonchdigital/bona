                ...
                <div class="navigation-bottom-right">
                    ...
                    @if(array_key_exists('phoneOne', $applicationGlobalOptions) && !is_null($applicationGlobalOptions['phoneOne']))
                        <div class="art-header-phone">
                            <a href="tel:{{ str_replace(' ', '', $applicationGlobalOptions['phoneOne']) }}" class="phone-full-number">{{ $applicationGlobalOptions['phoneOne'] }}</a>
                            <a href="tel:{{ str_replace(' ', '', $applicationGlobalOptions['phoneOne']) }}" class="phone-icon">
                    ...
                    <ul class="header-main-others">
                        ...
                        @guest
                            <li class="user-profile-list">
                                <a href="{{ App\Helpers\MultiLangRoute::getMultiLangRoute('auth.sign-in') }}" aria-label="{{ trans('base.user') }}" class="user-profile-link">
