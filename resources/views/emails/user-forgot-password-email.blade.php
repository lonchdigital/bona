                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            ...
                            <h2 class="align-center">{{ trans('emails.user-forgot-password-email.subject') }}</h2>
                            <p class="align-center">{{ trans('emails.user-forgot-password-email.main_text') }}</p>
                            <p class="align-center">
                                {{ trans('emails.user-forgot-password-email.new_password_text') }}
