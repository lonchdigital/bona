{{--
    Both states ship together and CSS shows one: the outline by default, the
    solid one once .link-heart-active is on the wrapper. Colour comes from
    currentColor, so each place — a dark header, a product photo, a bordered
    button — sets it with `color` and nothing here needs to know.
--}}
