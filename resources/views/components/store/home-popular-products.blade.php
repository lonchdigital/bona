    ...
    <section class="bona-popular" aria-labelledby="home-popular-title">
        <div class="bona-shell">
            <header class="bona-section-heading bona-section-heading--split">
                <div>
                    <p class="bona-kicker">{{ trans('base.home_popular_kicker') }}</p>
                    <h2 id="home-popular-title">{{ trans('base.home_popular_title') }}</h2>
                </div>
                <a class="bona-text-link" href="{{ App\Helpers\MultiLangRoute::getMultiLangRoute('store.all-products.page') }}">
                    {{ trans('base.home_all_models') }} <span aria-hidden="true">→</span>
                </a>
            </header>

            <div class="swiper bona-popular__slider" data-popular-slider aria-label="{{ trans('base.home_popular_title') }}">
