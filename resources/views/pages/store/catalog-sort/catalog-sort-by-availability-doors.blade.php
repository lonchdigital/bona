...
@section('title')
    ...
    @else
        ...
        <title>{{ trans('base.product_doors_availability') }} | {{ config('app.name') }}</title>
        <meta name="title" content="{{ trans('base.product_doors_availability') }}">
        @endif
        ...
        <div class="container">
            ...
            <div class="row">
                <header class=" col-12 art-header-left">
                    <div>
                        <h1 class="title">{{ trans('base.product_doors_availability') }}</h1>
                    </div>
                </header>
            </div>
