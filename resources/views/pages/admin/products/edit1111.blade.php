                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <select class="form-control select2" name="availability_status_id" id="availability_status_id">
                                            <option @if(!isset($product)) selected @endif disabled>{{ trans('admin.select') }} {{ mb_strtolower(trans('admin.availability_status')) }}</option>
                                            @foreach($productStatuses as $status)
                                                <option
                                                    @if(isset($product) && $product->availability_status_id === $status['id']) selected
                                    ...
                                    @if($productType->has_color)
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select multiple class="form-control select2" name="all_color_ids[]"
                                                ...
                                                @foreach($colors as $color)
                                                    <option
                                                        @if(isset($product) && $product->colors->contains('id', $color->id)) selected @endif
