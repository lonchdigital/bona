...
export default async function () {
    ...
    const [
        ...
        import('./store.all-products.page/tooltip'),
        import('./store.all-products.page/sync-filters'),
        import('./store.all-products.page/searchable-list'),
        import('./store.all-products.page/filter-submit'),
        import('./store.all-products.page/swiper'),
        import('./store.all-products.page/pagination')
    ]);
