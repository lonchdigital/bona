...
class ShowProductByAvailabilityPageAction extends BaseAction
{
    ...
    )
    {
        ...
        $productsPaginated = $productService->getProductsByAvailabilityPaginated(
            $filtersData->filters['per_page'] ?? 24,
            $page,
        );

        return view('pages.store.catalog-sort.catalog-sort-by-availability', [
            'productType' => $productType,
